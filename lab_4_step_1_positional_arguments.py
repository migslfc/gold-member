...
def main():
    translate_text('Ricochet, baby. Never the bullseye.','en','fr') # we provide the value for the arguments when we call the function in the correct positional order.
